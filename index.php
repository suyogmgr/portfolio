...
<body>
  <div class="root">
    <div class="grid-cont">
      ...
      <nav>
        <div class="nav-text">
        <a href="index.php"><h1 class="logo">SUYOG<span style="color: #fff;">.</span></h1></a>
        </div>
      ...
      <main>
        ...
        <div id="home" class="hero-content">
          ...
          <div class="hero-btn">
            <a href="./CV.pdf" class="resume" download>Download Resume</a>
          </div>
